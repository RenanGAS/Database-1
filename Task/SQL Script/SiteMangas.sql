...
# DROP TABLE IF EXISTS SITUACAO, MANGA, AUTOR, AUTOR_TEM_MANGA, CATEGORIA;
# DROP TABLE IF EXISTS MANGA_PERTENCE_CATEGORIA, SCANLATOR, REDESOCIAL, SCANLATOR_EDITA_MANGA, SCANLATOR_POSSUI_REDESOCIAL;
# DROP TABLE IF EXISTS CAPITULO, SCANLATOR_TRADUZ_CAPITULO, USUARIO, ESTADO, NOTA;
# DROP TABLE IF EXISTS USUARIO_ACESSA_MANGA, AVALIACAO, USUARIO_LE_CAPITULO, COMENTARIO;
